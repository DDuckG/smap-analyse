    ...
    for root_id, thread_mentions in by_root.items():
        ...
        summaries.append(
            ThreadSummary(
                ...
                top_comment_scores=[_score_for_ranking(item) for item in ranked_comments[:5]],
            )
        )
    ...
    for context in contexts:
        if context.mention_id == mention_id:
            ...
            return MentionContext(
                ...
                lineage_ids=trimmed_lineage,
                sibling_ids=context.sibling_ids[:window],
                direct_child_ids=context.direct_child_ids[:window],
