...
ASPECT_SEEDS: SeedSet = {
    ...
    "performance": ("performance", "hiệu năng", "hieu nang", "lag", "slow", "nhanh", "chậm", "cham"),
    "durability": ("durable", "durability", "bền", "ben", "wear", "broken"),
    "availability": ("stock", "available", "availability", "hết hàng", "het hang", "sold out"),
    "customer_service": ("service", "support", "cskh", "bảo hành", "bao hanh", "refund"),
    "delivery": ("delivery", "ship", "shipping", "giao", "arrive", "delay", "trễ", "tre"),
    ...
    "usability": ("easy", "hard to use", "khó dùng", "kho dung", "confusing", "usability"),
}

ISSUE_SEEDS: SeedSet = {
    "product_defect": ("defect", "broken", "lỗi", "loi", "hỏng", "hong", "fail"),
    "performance_problem": ("lag", "slow", "chậm", "cham", "freeze", "crash", "nóng", "nong"),
    ...
    "pricing_value_concern": ("overpriced", "expensive", "đắt", "dat", "pricey", "value"),
    "usability_problem": ("hard to use", "confusing", "khó dùng", "kho dung", "buggy flow"),
    "availability_problem": ("sold out", "hết hàng", "het hang", "unavailable", "backorder"),
}
...
_WORD_BOUNDARY = re.compile(r"(?<!\w)(?P<token>[\wÀ-ỹ]+(?:\s+[\wÀ-ỹ]+){0,2})(?!\w)", flags=re.UNICODE)
