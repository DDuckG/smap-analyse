...
class EnricherService:
    def __init__(
        ...
        *,
        topic_enricher: TopicCandidateEnricher | None = None,
        semantic_enricher: SemanticInferenceEnricher | None = None,
    ) -> None:
    ...
    def enrich_mentions(
        ...
        bundle.entity_facts, bundle.entity_candidate_clusters = self.entity_enricher.annotate_batch_local_candidates(
            bundle.entity_facts,
            mentions,
        )
        for mention in mentions:
